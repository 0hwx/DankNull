...
public interface IItemHandler {
     ...
     *         The returned ItemStack can be safely modified after, so item handlers should return a new or copied
     *         stack.
     **/
    @Nullable
     ...
     * <li>The actual items in the inventory, its fullness, or any other state are <strong>not</strong> considered by
     * isItemValid.</li>
     * </ul>
     * 
